...
<ul class="sidebar-menu" data-widget="tree">
    ...
    @if (Auth::user()->can('manage', \App\Models\Veiculo::class))
        <li class="{{ \App\Utils::checkRoute(['admin::veiculos.index', 'admin::categories.create']) ? 'active': '' }}">
            <a href="{{ route('admin::veiculos.index') }}">
                <i class="fa fa-tags"></i> <span>Veiculos</span>
            </a>
        </li>
    @endif
</ul>
